...
extern volatile VMBOOL opp_connected_event;
extern volatile VMBOOL opp_disconnected_event;
...
//int debug_printf(char const* const format, ...);

//#define DEBUG_PRINTFZ(...) cprintf(__VA_ARGS__)
