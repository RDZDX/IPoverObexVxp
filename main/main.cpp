...
//                main_timer_id = vm_create_timer(1000 / 15, timer);  // 15 fps
                main_timer_id = vm_create_timer_ex(1000 / 15, timer);  // 15 fps
            }
...
//        vm_delete_timer(main_timer_id);
        vm_delete_timer_ex(main_timer_id);
        main_timer_id = -1;
    }
...
void show_start_menu() {
//    cprintf("Select mode:\n");
    cprintf("Enter mode # from the list:\n");
    cprintf("1. Listen\n");
    cprintf("2. Connect to device from list\n");
    cprintf("3. Connect last used\n\n");
